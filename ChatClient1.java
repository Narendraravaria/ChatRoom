...
public class ChatClient1 {
	...
	private String getServerAdd(){
		return JOptionPane.showInputDialog(frame, "Enetr Server IP address :","Wlecome to Chat ROOM",JOptionPane.PLAIN_MESSAGE);
	}
	//Client name
	private String getName(){
		return JOptionPane.showInputDialog(frame, "Choose Screen Name :","Screen Name Selection",JOptionPane.PLAIN_MESSAGE);
	}
